      ...
      <Container>
        ...
        <article className="w-75 m-auto pt-2 text-justify">
          ...
          <p className="mt-4 pt-2">
            ...
            <b>{occupation}</b>. This blog is mostly a repository of some of the
            stuff I have learnt and continue to learn in my journey so far. It's
            my own small corner on the web where I document whatever I find
            interesting.
          </p>
          <p className="">
            In my spare time, I love reading historical novels or watching great
            shows.
          </p>
          <p className="">
